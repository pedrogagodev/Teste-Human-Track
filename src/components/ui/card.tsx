...
function Card({
	...
	return (
		<div
			...
			data-size={size}
			className={cn(
				"group/card flex flex-col gap-4 overflow-hidden rounded-2xl bg-card p-2 py-6 text-card-foreground text-xs/relaxed shadow-[0_1px_3px_0_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.05)] has-[>img:first-child]:pt-0 has-data-[slot=card-footer]:pb-0 data-[size=sm]:gap-2 data-[size=sm]:p-4 data-[size=sm]:has-data-[slot=card-footer]:pb-0 md:p-6 *:[img:first-child]:rounded-2xl *:[img:last-child]:rounded-2xl",
				className,
			)}
			{...props}
		/>
