...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				"group/calendar rounded-2xl border border-input in-data-[slot=popover-content]:border-0 bg-card in-data-[slot=popover-content]:bg-transparent p-4 in-data-[slot=popover-content]:shadow-none shadow-[0_1px_3px_0_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.05)] [--cell-size:--spacing(7)]",
			...
			classNames={{
				...
				day: cn(
					"group/day relative h-(--cell-size) flex-1 select-none rounded-(--cell-radius) p-0 text-center [&:last-child[data-selected=true]_button]:rounded-r-(--cell-radius)",
				...
				today: cn(
					"h-max rounded-(--cell-radius) text-foreground data-[selected=true]:rounded-none",
